...
function DataService:SetPlayerData(Player, Function)
		assert(Player ~= nil and Function ~= nil, "Object passed to GetPlayerData is nil")
		if DataService.CachedProfiles[Player.UserId] ~= nil then
      Function()
